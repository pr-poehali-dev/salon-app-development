...
const Index = () => {
  ...
  const priceList = [
    { service: 'Стрижка женская', price: '2500₽' },
    { service: 'Стрижка мужская', price: '1500₽' },
    { service: 'Окрашивание', price: '4500₽' },
    { service: 'Укладка', price: '1800₽' },
    { service: 'Маникюр', price: '1200₽' },
    { service: 'Педикюр', price: '1800₽' },
    { service: 'Массаж лица', price: '2200₽' },
    { service: 'Уход за кожей', price: '3000₽' }
  ];
